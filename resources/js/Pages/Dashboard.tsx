...
import JumlahPendudukChart from '@/Components/charts/bar-chart/JumlahPendudukChart';
...
<AuthenticatedLayout>
    ...
    <h1 className='mb-3 text-3xl text-center font-bold text-gray-700 dark:text-gray-400'>Data Statistik Provinsi
        Kepulauan
        Riau</h1>
    ...
    <div className="grid grid-cols-2 gap-6">
        <div className="col-span-2 w-full overflow-auto rounded-lg bg-white/20 p-5 shadow-lg backdrop-blur-md">
            <h2 className="mb-3 text-center font-semibold text-gray-600 dark:text-gray-400">
                Distribusi Penduduk Kepri
            </h2>
        ...
        <div className="w-full overflow-auto rounded-lg bg-white/20 p-5 shadow-lg backdrop-blur-md">
            <h2 className="mb-3 text-center font-semibold text-gray-600 dark:text-gray-400">
                Distribusi Penduduk Kepri
            </h2>
            <JumlahPendudukChart />
