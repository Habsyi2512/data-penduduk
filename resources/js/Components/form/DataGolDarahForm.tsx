...
interface DataGolDarahFormProps{
            ...
            setOpenByIdx: React.Dispatch<SetStateAction<boolean[]>>;
                ...
                remove: <X=any>(index: number) => X | undefined,
                    ...
                    formik: FormikProps<{ forms: {gol_darah : string} [] }>,
                        ...
                        export default function DataGolDarahForm({
                        formik,
                        push,
                        remove,
                        openByIdx,
                                ...
                                <Box key={index} className="my-3">
                                    ...
                                    <div className={`grud transition-all ${ openByIdx[index] ? 'grid-rows-[1fr]'
                                        ...
                                        <div className="overflow-hidden">
                                            <div className="p-5">
                                                <div>
                                                    <Label htmlFor={`forms.${index}.gol_darah`}>
                                                        Golongan Darah
                                                    </Label>
                                                    <InputText name={`forms.${index}.gol_darah`} value={ form.gol_darah
                                                        || '' } />
                                                    <ErrorMessage name={`forms.${index}.gol_darah`} component="div"
