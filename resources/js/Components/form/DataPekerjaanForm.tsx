...
interface DataPekerjaanFormProps {
            ...
            setOpenByIdx: React.Dispatch<SetStateAction<boolean[]>>;
                ...
                remove: <X=any>(index: number) => X | undefined,
                    ...
                    formik: FormikProps<{ forms: { pekerjaan: string }[] }>,
                        ...
                        export default function DataPekerjaanForm({
                        formik,
                        push,
                        remove,
                        openByIdx,
                                ...
                                <Box key={index} className="my-3">
                                    ...
                                    <div className={`grud transition-all ${ openByIdx[index] ? 'grid-rows-[1fr]'
                                        ...
                                        <div className="overflow-hidden">
                                            <div className="p-5">
                                                <div>
                                                    <Label htmlFor={`forms.${index}.pekerjaan`}>
                                                        Pekerjaan
                                                    </Label>
                                                    <InputText name={`forms.${index}.pekerjaan`} value={ form.pekerjaan
                                                        || '' } />
                                                    <ErrorMessage name={`forms.${index}.pekerjaan`} component="div"
