...
export default function ConfirmSubmitModal<T = { forms: InputPendudukProps[] }>({
    index,
    isOpenSubmitModal,
            ...
            {isOpenSubmitModal && (
                ...
                >
                    <motion.div className="w-full max-w-xl rounded-xl bg-gray-200 shadow">
                        ...
                        <p className="px-5 pb-2 pt-5 font-inter font-medium text-gray-600">Silahkan periksa kembali data inputan jika anda ragu {index && <span className="text-lg font-bold text-gray-700">form {index + 1}</span>}</p>
                        <div className="flex justify-end space-x-3 p-5 font-inter font-medium">
                            ...
                            <button onClick={() => setIsOpenSubmitModal(false)} className="border-1 rounded-md border-gray-300 bg-gray-300 px-3 py-2 hover:bg-gray-400">
                                Batal
                            </button>
                        </div>
                    </motion.div>
