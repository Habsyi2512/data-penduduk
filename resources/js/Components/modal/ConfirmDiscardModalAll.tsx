...
export default function ConfirmDiscardModalAll({ state, setState, title = 'Hapus Data?', onClick }: ConfirmDiscardModalProps) {
    return (
        <AnimatePresence>
            {state && (
                <motion.div
                ...
                >
                    <motion.div className="w-full max-w-xl rounded-xl bg-gray-200 shadow">
                        ...
                        <p className="px-5 pb-2 pt-5 font-inter font-medium text-gray-600">Yakin Ingin Menghapus?</p>
